...
export default function Question({num, setNum, updateScore}) {
  const navigate = useNavigate();


  const handleAnswear=(type,value)=>{
...
return (
  <div className="content" id="question">
      ...
      <button className='btn btn-warning' onClick={handleAnswear(currentQuestion.type,1)}>{currentQuestion.A}</button>
      <button className='btn btn-warning' onClick={handleAnswear(currentQuestion.type,0)}>{currentQuestion.B}</button>
